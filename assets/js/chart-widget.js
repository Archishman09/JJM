(function ($) {
    ...
    var optionscolumnchart = {
        series: [
            {
                name: "Success",
                data: [70, 40, 55, 40, 30, 50, 40, 30, 40, 45, 10, 60],
            },
            {
                name: "Unsuccess",
                data: [30, 40, 45, 10, 60, 60, 45, 70, 40, 55, 40, 30],
            },
        ],
        chart: {
            type: "bar",
        ...
        xaxis: {
            categories: ["29/06/23", "30/06/23", "01/07/23", "02/07/23", "03/07/23", "04/07/23", "05/07/23", "06/07/23", "07/07/23", "08/07/23", "09/07/23", "10/07/23"],
            floating: false,
            axisTicks: {
                show: false,
            },
        ...
        colors: ["#51bb25", CubaAdminConfig.secondary],
        fill: {
            type: "gradient",
            gradient: {
                shade: "light",
    ...
    var optionscolumnchart = {
        series: [
            {
                name: "Success",
                data: [55, 40, 30, 50, 40, 30, 40, 45, 10, 60],
            },
            {
                name: "Unsuccess",
                data: [45, 10, 60, 60, 45, 70, 40, 55, 40, 30],
            },
        ],
        chart: {
            type: "bar",
        ...
        xaxis: {
            categories: ["07/05-13/05", "14/05-20/05", "21/05-27/05", "28/05-03/06", "04/06-10/06", "11/06-17/06", "18/06-24/06", "25/06-01/07", "02/07-08/07", "09/07-15/07"],
            floating: false,
            axisTicks: {
                show: false,
            },
    ...
    var optionscolumnchart = {
        ...
        yaxis: {
            title: {
                text: "Your Monthly Called Graph",
                style: {
                    fontSize: "14px",
                    fontFamily: "Roboto, sans-serif",
                    fontWeight: 500,
    ...
    var chartcolumnchart = new ApexCharts(
        document.querySelector("#chart-widget16"),
        optionscolumnchart
    );
    chartcolumnchart.render();
    ...
    var optionscolumnchart = {
        ...
        yaxis: {
            title: {
                text: "Your Quarterly Called Graph",
                style: {
                    fontSize: "14px",
                    fontFamily: "Roboto, sans-serif",
                    fontWeight: 500,
    ...
    var chartcolumnchart = new ApexCharts(
        document.querySelector("#chart-widget17"),
        optionscolumnchart
    );
    chartcolumnchart.render();
