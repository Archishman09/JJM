...
(function ($) {
  ...
  $("#monthlyTable").hide();
  $("#quarterlyTable").hide();
  $("#call-answered-no-question").hide();
  $("#question2").hide();
  $("#question3").hide();
  $("#question4").hide();
  $("#question4-a").hide();
  ...
  $("#question7").hide();
  $("#question8").hide();
  $("#any-other-feedback").hide();
  $("#reason-for-declined-to-feedback").hide();
  $("#otherTextarea").hide();
  ...
  $("#quarterly-btn").on("click", function () {
    $("#quarterlyTable").show();
    $("#weeklyTable").hide();
    $("#dailyTable").hide();
    $("#monthlyTable").hide();
  ...
  $("#call-answered-yes").on("click", function () {
    $("#question2").show();
    $("#call-answered-no-question").hide();
  });

  $("#call-answered-no").on("click", function () {
    $("#question2").hide();
    $("#question3").hide();
    $("#question4").hide();
    $("#question4-a").hide();
    ...
    $("#any-other-feedback").hide();
    $("#reason-for-declined-to-feedback").hide();
    $("#call-answered-no-question").show();
  });

  $("#question2-yes").on("click", function () {
    $("#question3").show();
    $("#reason-for-declined-to-feedback").hide();
    $("#any-other-feedback").show();
  });
  ...
  $("#question2-no").on("click", function () {
    ...
    $("#question8").hide();
    $("#any-other-feedback").hide();
    $("#reason-for-declined-to-feedback").show();
  });
  ...
  $("#question4-yes").on("click", function () {
    $("#question5").show();
    $("#question4-a").hide();
    $("#any-other-feedback").show();
  });

  $("#question4-no").on("click", function () {
    $("#question4-a").show();
    $("#question5").hide();
    $("#question5-a").hide();
    $("#question6").hide();
  ...
  $("#question4-a-yes").on("click", function () {
    $("#question5").show();
    $("#any-other-feedback").show();
  });

  $("#question4-a-no").on("click", function () {
    $("#question5").hide();
    $("#any-other-feedback").show();
  });

  $("#question5-yes").on("click", function () {
    $("#question5-a").hide();
    $("#question6").show();
    $("#question7").show();
    $("#question8").show();
  ...
  $("#question5-no").on("click", function () {
    $("#question5-a").show();
    $("#question6").hide();
    $("#question7").hide();
    $("#question8").hide();
  ...
  $("#otherradiobtn").on("click", function () {
    $("#otherTextarea").show();
  });
