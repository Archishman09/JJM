am4core.ready(function () {
  ...
  {
    // Is tap connection provided?

    var container = am4core.create("pie_chart1", am4core.Container);
    ...
    document.getElementById("pie_chart1").style.width = "-100px";

    // Add and configure Series
    var pieSeries1 = chart1.series.push(new am4charts.PieSeries());
    pieSeries1.dataFields.value = "number";
    pieSeries1.dataFields.category = "exist";

    pieSeries1.slices.template.states.getKey(
      "active"
    ).properties.shiftRadius = 0;

    pieSeries1.labels.template.radius = am4core.percent(30);
    pieSeries1.labels.template.inside = true;
    pieSeries1.labels.template.disabled = false;
    pieSeries1.ticks.template.disabled = true;
    pieSeries1.labels.template.text = "{value.percent.formatNumber('#.#')}%";

    //Override original colors
    var colorSet = new am4core.ColorSet();
    colorSet.list = ["#3182bd", "#fcae91"].map(function (color) {
      return new am4core.color(color);
    });
    pieSeries1.colors = colorSet;

    pieSeries1.slices.template.stroke = am4core.color("#fff");
    pieSeries1.slices.template.strokeWidth = 1.5;
    pieSeries1.slices.template.strokeOpacity = 1;

    pieSeries1.slices.template.events.on("hit", function (event) {
      selectSlice(event.target.dataItem);
    });

    // Is water supplied adequate?
    var container = am4core.create("pie_chart2", am4core.Container);
    container.width = am4core.percent(90);
    container.height = am4core.percent(90);
    container.layout = "horizontal";
    ...
    function selectSlice(dataItem) {
      ...
      pieSeries2.colors.list = ["#3182bd"].map(function (color) {
        return new am4core.color(color);
      });
    ...
    // Is water supplied regularly?

    var container = am4core.create("pie_chart4", am4core.Container);
    container.width = am4core.percent(90);
    container.height = am4core.percent(90);
    container.layout = "horizontal";
    ...
    // How many days in a week water is supplied?

    var container = am4core.create("pie_chart5", am4core.Container);
    container.width = am4core.percent(90);
    container.height = am4core.percent(90);
    ...
    //chart1.legend = new am4charts.Legend();
    chart1.data = [
      { exist: "1 day", number: 15 },

      { exist: "2 days", number: 15 },

      { exist: "3 days", number: 15 },

      { exist: "4 days", number: 15 },

      { exist: "5 days", number: 15 },

      { exist: "6 days", number: 15 },

      { exist: "7 days", number: 10 },
    ];
    ...
    pieSeries1.labels.template.radius = am4core.percent(10);
    pieSeries1.labels.template.inside = true;
    pieSeries1.labels.template.disabled = false;
    pieSeries1.ticks.template.disabled = true;
    pieSeries1.labels.template.text = "{value.percent.formatNumber('#.#')}%";
    ...
    var container = am4core.create("pie_chart6", am4core.Container);
    container.width = am4core.percent(90);
    container.height = am4core.percent(90);
    container.layout = "horizontal";
